<%-- 
    Document   : index
    Created on : Apr 29, 2019, 2:37:39 PM
    Author     : Riougroseno
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
             ...
             <a class="btn btn-warning mb-3 mt-3" href="barangController?proses=input-barang">Tambah data</a>
        ...
        %>
            <tr>
              <th scope="row"><%=data.get(x).getKodeBarang()%></th>
                ...
                <td>    
                    <a class="btn btn-primary" href="barangController?proses=edit-barang&id=<%=data.get(x).getKodeBarang()%>">Edit</a>
