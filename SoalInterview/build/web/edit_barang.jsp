<%-- 
    ...
    Created on : Apr 29, 2019, 3:37:05 PM
    Author     : Riougroseno
--%>
     ...
     <div class="container">
        ...
        <form  action="barangController?data=barang&proses=edit-barang" method="post">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="kodebarang" name="kode_barang"  value="<%=data.get(0).getKodeBarang()%>">
            </div>
            <div class="form-group">
              <label for="namaBarang">Nama Barang</label>
              <input type="text" class="form-control" name="nama_barang" value="<%=data.get(0).getNamaBarang()%>">
              <input type="hidden" class="form-control" name="id" value="<%=data.get(0).getKodeBarang()%>">
            </div>
             <div class="form-group">
              <label for="hargaJual">Harga Jual</label>
               <input type="text" class="form-control" name="harga_jual" value="<%=data.get(0).getHargaJual()%>">
              <input type="hidden" class="form-control" name="id" value="<%=data.get(0).getKodeBarang()%>">
            </div>
             <div class="form-group">
              <label for="hargaBeli">Harga Beli</label>
              <input type="text" class="form-control" name="harga_beli" value="<%=data.get(0).getHargaBeli()%>">
              <input type="hidden" class="form-control" name="id" value="<%=data.get(0).getKodeBarang()%>">
            </div>
            <div class="form-group">
