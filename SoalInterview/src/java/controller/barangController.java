...
//        processRequest(request, response);
        ...
        if (data != null) {
            if (data.equals("barang")) {
                ...
                um.setKodeBarang(request.getParameter("kode_barang"));
                um.setNamaBarang(request.getParameter("nama_barang"));
                um.setHargaJual(request.getParameter("harga_jual"));
                um.setHargaBeli(request.getParameter("harga_beli"));
